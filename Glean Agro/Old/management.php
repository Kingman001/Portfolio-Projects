<?php
define('TITLE', 'Management | Glean Agro');
...
<main>
    ...
    <section class="about" id="aboutus">
        ...
        <div>
            <!-- Tab links -->
            <div class="tab">
                <button class="tablinks activeMenu" onclick="openTab(event, 'Management')">Management</button>
                <button class="tablinks" onclick="openTab(event, 'WhoWeAre')">Who we Are</button>
                <button class="tablinks" onclick="openTab(event, 'OurCoreValue')">Our Core Values</button>
